...
public class ImportStats extends Dialog<Integer> {
	...
	public ImportStats(CRStatsInfo crStatsInfo) {
		...
		int[] importRangeRPY = UserSettings.get().getRange(RangeType.ImportRPYRange);
		tfYear[0] = createTF (importRangeRPY[0], true);
		grid.addRow(1, 
		...
		tfYear[1] = createTF (importRangeRPY[1], true);
		grid.addRow(2, 
		...
		int[] importRangePY = UserSettings.get().getRange(RangeType.ImportPYRange);

		tfYear[2] = createTF (importRangePY[0], true);
		grid.addRow(5, 
		...
		tfYear[3] = createTF (importRangePY[1], true);
		grid.addRow(6, 
